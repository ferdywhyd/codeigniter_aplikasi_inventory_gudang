...
class Admin_model extends CI_Model
{
    ...
    {
        $this->db->join('user u', 'b.user_id = u.id_user');
    ...
    public function getBarangUser($limit = null, $userId = null)
    {
    ...
    public function barangkeluar_user($limit = null, $userId = null, $range = null)
    {
        $userId = $this->session->userdata('login_session')['user'];
        $this->db->select('*');
    ...
    public function barangmasuk_user($limit = null, $userId = null, $range = null)
    {
        $userId = $this->session->userdata('login_session')['user'];
        $this->db->select('*');
