    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select" >
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <option value="<?= $b['id_barang'] ?>"><?= $b['nama'] . ' -> ' . $b['nama_barang']?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <?php endif; ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="lokasi">DF Cabang</label>
                    <div class="col-md-5">
                        <input value="<?= set_value('lokasi'); ?>" name="lokasi" id="lokasi" type="text" class="form-control" placeholder="Lokasi Cabang ....">
