...
<h5 class="text-black op-7 mb-2"><img src="assets/img/teamwork.png" width="37px"> Hello, <b class="text-info"><?= userdata('nama'); ?></b></h5>
        <h4 class="h5 align-middle m-0 font-weight-bold text-danger">
            <marquee>Welcome To Daffa Ladies & Kids Inventory Application Information System</marquee>
        </h4>
    </div>
