...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/img/logodaffa1.jpg"/>
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
                ...
                <div class="sidebar-brand-icon">
                  ...
                  <i aria-hidden="true"><img src="<?= base_url(); ?>assets/img/logodaffa4.png" width="75"></i>
                </div>
                <div class="sidebar-brand-text mx-2 text-xs" >Daffa Ladies & Kids</div>
            </a>
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="assets/img/people.png" width="20px">
                            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Warehouse Inventory &bull; 2024 &bull; by <?= anchor('#', 'Daffa Ladies & Kids'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
